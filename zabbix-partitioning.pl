#!/usr/bin/env perl
# yum -y install perl-Sys-Syslog perl-DateTime perl-DBD-mysql
# grant all privileges on zabbix.* to zbx_part@localhost identified by "dwyQv5X3G6WwtYKg";
# ALTER TABLE `history` PARTITION BY RANGE(clock)(PARTITION p2018_12_11 VALUES LESS THAN (UNIX_TIMESTAMP("2018-12-12 00:00:00")) ENGINE=InnoDB);
# ALTER TABLE `history_uint` PARTITION BY RANGE(clock)(PARTITION p2018_12_11 VALUES LESS THAN (UNIX_TIMESTAMP("2018-12-12 00:00:00")) ENGINE=InnoDB);
# ALTER TABLE `history_log` PARTITION BY RANGE(clock)(PARTITION p2018_12_11 VALUES LESS THAN (UNIX_TIMESTAMP("2018-12-12 00:00:00")) ENGINE=InnoDB);
# ALTER TABLE `history_text` PARTITION BY RANGE(clock)(PARTITION p2018_12_11 VALUES LESS THAN (UNIX_TIMESTAMP("2018-12-12 00:00:00")) ENGINE=InnoDB);
...
my $tables = {	'history' => { 'period' => 'day', 'keep_history' => '3'},
		'history_log' => { 'period' => 'day', 'keep_history' => '3'},
		'history_str' => { 'period' => 'day', 'keep_history' => '3'},
		'history_text' => { 'period' => 'day', 'keep_history' => '3'},
		'history_uint' => { 'period' => 'day', 'keep_history' => '3'},
